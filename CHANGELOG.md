...
### Added
- Net Worth balances auto-update from the Budget: debt payments lower the matching debt account, savings and pre-tax investment contributions raise the matching account (matched by name). A manually typed balance is authoritative for its month and becomes the new base going forward; auto-derived balances show an "(estimated)" placeholder. Update manually anytime to reflect interest or market gains
